...
from buildJenkinsJobs import runJobs as runJenkinsJobs
from git import Repo
from termcolor import cprint


def mergeFlow(branches, currentBranchName, buildJenkinsJob):
    print('\n' + '=' * 40 + '\n')
...
if __name__ == "__main__":
    ...
    parser.add_argument('-b', '--build', help="build jenkins job and publish",
                        type=bool, default=False)
    args = parser.parse_args()
    targetBranches = args.targetBranches
    buildJenkinsJob = args.build
    ...
    mergeFlow(targetBranches, currentBranchName, buildJenkinsJob)
